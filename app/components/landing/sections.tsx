...
export default function Sections() {
  ...
  return (
    <>
      <h2 className="uppercase leading-10 lg:text-4xl text-2xl my-20">
        {landingCopy.header.mainTitle}
      </h2>
      ...
      <div
        className="w-[90%] lg:w-max  border-4 border-liberty rounded-lg  mx-auto mt-20"
        style={{ padding: "5px" }}
      >
      ...
      <div className="flex items-center justify-center mt-36 px-3">
        ...
        <Image
          className="lg:ms-5 h-[50px] w-[50px]"
          src={"/img/icon-sad-kirbys.svg"}
          width={50}
          height={50}
          alt="Problem"
        />
      ...
      <h4 className="uppercase  my-20 lg:text-2xl text-lg">
        {landingCopy.problemSection.footerNote}
      </h4>
      ...
      <div className="mt-20 lg:w-max mx-auto">
        <h2
          className="lg:text-2xl text-xl leading-10 my-4"
          dangerouslySetInnerHTML={{ __html: landingCopy.footerNote }}
        ></h2>
        <Image
          className="ms-auto"
          src="/img/footer-vampire.svg"
          width={300}
          height={80}
          alt="Vampire Attack"
        />
