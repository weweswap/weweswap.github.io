...
export default function Sections() {
    return (
        <>
            <h2 className="uppercase leading-10 lg:text-4xl md:text-2xl my-20">{landingCopy.header.mainTitle}</h2>
            <div className="w-max mx-auto mt-24 relative ">
                <IconTopLeftBorder />
                <h1 className="uppercase leading-relaxed font-black dogica-bold lg:text-6xl md:text-4xl text-xl  text-center color-turquoise" dangerouslySetInnerHTML={{ __html: landingCopy.header.subTitle }}></h1>
            ...
            <div className="w-full lg:w-max border border-4 border-liberty rounded-lg  mx-auto p-3 mt-20">
            ...
            <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 mt-20 gap-20">
                    ...
                    <div key={index}>
                        ...
                        <ul>
                            {item.description.map((description, index) => (
                                <li className="list-disc w-max mx-auto leading-10 lg:px-3 lg:text-base text-sm">{description} </li>
                            ))}
                        </ul>
                    </div>
                ))}
            ...
            <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 mt-24 gap-20">
                {landingCopy.solutionSection.solutions.map((item, index) => (
                    <div key={index}>
                        ...
                        <p className="leading-8 px-3 lg:text-base text-sm"> {item.description}</p>
                    </div>
                ))}
            </div>
